...
export interface UsageJobData {
  ...
  sessionId: string;
  /**
   * Optional tenant-supplied label from the x-user-id request header.
   * MUST be an opaque token (e.g. hashed user ID, session UUID).
   * Never pass real user identifiers (email, name, phone). Callers are
   * responsible for pseudonymization. Stored verbatim in request_spans.
   */
  userLabel?: string;
}
